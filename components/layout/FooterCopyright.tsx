  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
        <div
          className="text-sm transition-colors duration-300 hover:text-[#f9bc60]"
          style={{ color: "#abd1c6" }}
        >
        ...
        >
          ...
          <span
            className="text-lg animate-pulse transition-transform duration-300 group-hover:scale-125"
