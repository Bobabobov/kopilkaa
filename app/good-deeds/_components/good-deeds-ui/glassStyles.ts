...
/** Базовая панель «стекло» для раздела /good-deeds */
export const goodDeedsGlassPanel = cn(
...
export const goodDeedsGlassShine = cn(
  "pointer-events-none absolute inset-x-4 top-0 h-px",
  "bg-gradient-to-r from-transparent via-white/30 to-transparent",
);

export const goodDeedsGlassCard = cn(
  "relative overflow-hidden rounded-2xl",
