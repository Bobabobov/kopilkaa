        ...
        <div className="bg-gradient-to-br from-[#004643]/95 to-[#001e1d]/95 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-[#abd1c6]/20">
          ...
          <div className="text-center mb-8">
            <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-[#f9bc60] to-[#e8a545] flex items-center justify-center shadow-lg">
              <svg className="w-8 h-8 text-[#001e1d]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
              </svg>
            </div>
            <h1 className="text-3xl font-bold mb-2" style={{ color: '#fffffe' }}>Создать аккаунт</h1>
            <p className="text-sm" style={{ color: '#abd1c6' }}>Присоединяйтесь к нашей платформе</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6" noValidate>
          ...
          <div className={`flex items-start gap-3 p-4 rounded-xl border-2 transition-all duration-300 ${
            ...
            <input 
              ...
              style={{ 
                accentColor: '#f9bc60',
                backgroundColor: formData.acceptTerms ? '#f9bc60' : 'transparent'
              }}
            />
            <label htmlFor="acceptTerms" className="text-sm leading-relaxed" style={{ color: '#abd1c6' }}>
              Я соглашаюсь с{" "}
              <Link href="/terms" target="_blank" className="font-semibold hover:underline transition-all duration-300" style={{ color: '#f9bc60' }}>
