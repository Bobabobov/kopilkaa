...
const LEVELS = [
  {
    ...
    obtain: "Следующий уровень открывается после 3 одобренных заявок",
    desc: "Начало пути в Копилке и базовая проверка заявки.",
    icon: UserRound,
    tone: {
      bg: "bg-[#0f2f28]/80",
  ...
  },
  {
    ...
    obtain: "Следующий уровень открывается после 6 одобренных заявок",
    desc: "Появляются первые подтверждения — доверие постепенно растёт.",
    icon: BadgeCheck,
    tone: {
      bg: "bg-[#10382f]/85",
  ...
  },
  {
    ...
    support: "от 50 до 700 ₽",
    obtain: "Следующий уровень открывается после 9 одобренных заявок",
    desc: "Заявки проходят регулярно, можно запрашивать больше.",
    icon: ShieldCheck,
    tone: {
      bg: "bg-[#123f34]/85",
  ...
  },
  {
    ...
    support: "от 50 до 1 500 ₽",
    obtain: "Следующий уровень открывается после 12 одобренных заявок",
    desc: "Опыт участия подтверждён, лимит поддержки расширен.",
    icon: TrendingUp,
    tone: {
      bg: "bg-[#0f3d33]/90",
  ...
  },
  {
    ...
    support: "от 50 до 3 000 ₽",
    obtain: "Следующий уровень открывается после 15 одобренных заявок",
    desc: "Сообщество доверяет вам на постоянной основе.",
    icon: Star,
    tone: {
      bg: "bg-[#0d3f32]/90",
  ...
  },
  {
    ...
    support: "от 50 до 5 000 ₽",
    obtain: "Это максимальный уровень",
    desc: "Максимальный уровень доверия и доступных лимитов.",
    icon: Crown,
    tone: {
      bg: "bg-[#0c4536]/90",
    ...
    <section className="space-y-3">
      <div className="space-y-1">
        ...
        <p className="text-xs text-[#94a1b2]/90">
          Доверие считается автоматически: +1 уровень за каждые 3 одобренные заявки
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-[#2c4f45]/50 bg-[#0b2a24]/70 backdrop-blur-sm p-4 sm:p-5 shadow-[0_16px_38px_-30px_rgba(0,0,0,0.45)] space-y-2">
        ...
        <p className="text-xs sm:text-sm text-[#9bb3ab] leading-relaxed">
          В Копилке нет автоматических выплат и гарантированных сумм. Поддержка — решение сообщества, а не функция сайта.
        </p>
        <p className="text-xs sm:text-sm text-[#9bb3ab] leading-relaxed">
          Уровень доверия показывает ориентир по сумме поддержки и растёт каждые 3 одобренные заявки, но не гарантирует одобрение заявки.
        </p>
      </div>
