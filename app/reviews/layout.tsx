...
export const metadata: Metadata = {
  ...
  description: "Читайте честные отзывы участников платформы Копилка. Реальные истории тех, кто оформил заявку и получил одобрение",
  keywords: ["отзывы", "отзывы участников", "реальные отзывы", "копилка", "взаимопомощь"],
  alternates: {
    canonical: "/reviews",
  },
  openGraph: {
