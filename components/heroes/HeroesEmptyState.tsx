      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-lg mb-8 leading-relaxed" style={{ color: "#abd1c6" }}>
            Здесь будут отображаться публичные профили пользователей, оплативших размещение в разделе «Герои».
            Разместите свой профиль и участвуйте в рейтинге раздела.
          </p>
