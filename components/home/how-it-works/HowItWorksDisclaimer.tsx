    ...
    >
      ...
      >
        ...
        <p className="text-sm leading-relaxed pt-0.5" style={{ color: "#abd1c6" }}>
          «Копилка Online» поощряет авторов за уникальный контент. Гонорары и гранты зависят от качества публикаций и активности на платформе; выплаты производятся по СБП.
        </p>
      </div>
    </motion.div>
  );
