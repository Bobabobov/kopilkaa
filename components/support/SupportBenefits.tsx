...
const benefits = [
  ...
  {
    icon: "Share",
    title: "Поддержка помогает авторам",
    description:
      "Проект формирует фонд вознаграждений для гонораров авторам и развивает платформу.",
    color: "#abd1c6",
  },
  {
    icon: "BarChart3",
  ...
  },
  {
    ...
    description:
      "Никаких обещаний выгоды. Это добровольный вклад в развитие проекта и фонд гонораров для авторов.",
    color: "#f9bc60",
  },
];
