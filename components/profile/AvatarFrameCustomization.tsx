  ...
  const renderAvatarPreview = (frameConfig: any) => {
      ...
      return (
        <div className="w-16 h-16 rounded-lg overflow-hidden relative bg-gray-900/20">
          ...
          <div className="absolute inset-2 rounded-md overflow-hidden">
            ...
            <div
              className={`w-full h-full flex items-center justify-center bg-gradient-to-br from-emerald-500 via-green-500 to-lime-600 text-white font-bold text-xl ${user.avatar ? "hidden" : ""}`}
            >
    ...
    return (
      ...
      >
        ...
        <div
          className={`w-full h-full flex items-center justify-center ${user.avatar ? "hidden" : ""}`}
        >
          {appliedAvatarFallback}
        </div>
      </div>
