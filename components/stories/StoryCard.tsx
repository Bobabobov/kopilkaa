      ...
      <Link href={`/stories/${story.id}`}>
        ...
        >
          ...
          <div className="flex flex-col flex-1 min-w-0">
            {/* Заголовок */}
            <h3
              className="text-xl font-bold transition-all duration-300 line-clamp-2 break-words overflow-hidden mb-3 h-16 group-hover:text-[#004643] group-hover:scale-[1.02]"
              style={{ color: "#001e1d" }}
            >
              {story.title}
            </h3>
            ...
            {/* Описание */}
            <p
              className="text-sm leading-relaxed line-clamp-3 break-words overflow-hidden flex-1 mb-4 h-20 transition-all duration-300 group-hover:text-[#2d5a4e] group-hover:scale-[1.01]"
              style={{ color: "#2d5a4e" }}
            >
              {story.summary}
            </p>
            ...
            {/* Метаданные */}
            <div
              className="bg-gradient-to-r from-[#abd1c6]/80 to-[#94c4b8]/70 rounded-2xl p-4 border-2 border-[#abd1c6]/60 shadow-lg flex-shrink-0 transition-all duration-300 group-hover:shadow-xl group-hover:border-[#f9bc60]/40 group-hover:bg-gradient-to-r group-hover:from-[#abd1c6]/90 group-hover:to-[#94c4b8]/80"
              style={{
                background:
                  "linear-gradient(135deg, rgba(171,209,198,0.8) 0%, rgba(148,196,184,0.7) 100%)",
              }}
            >
              <div className="flex items-center justify-between text-xs">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-1 bg-white/90 rounded-xl px-3 py-2 shadow-md border border-[#abd1c6]/40 transition-all duration-300 hover:shadow-lg hover:scale-105 hover:border-[#f9bc60]/60">
                    ...
                    <span className="font-medium text-[#001e1d]">
                ...
                <div
                  className="flex items-center gap-1 bg-white/90 rounded-xl px-3 py-2 shadow-md border border-[#abd1c6]/40 transition-all duration-300 hover:shadow-lg hover:scale-105 hover:border-[#e16162]/60"
                  style={{ color: "#e16162" }}
                >
                  <LucideIcons.Heart
                    size="sm"
            ...
            {/* Дата */}
            <div
              className="pt-3 border-t mt-4 flex-shrink-0 transition-all duration-300 group-hover:border-[#f9bc60]/40"
              style={{ borderColor: "#abd1c6/50" }}
            >
              <span
                className="text-xs font-medium transition-colors duration-300 group-hover:text-[#004643]"
                style={{ color: "#2d5a4e" }}
              >
                {story.createdAt
