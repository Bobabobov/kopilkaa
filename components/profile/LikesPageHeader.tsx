  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        >
          <LucideIcons.ArrowLeft size="sm" className="text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white transition-colors" />
        ...
        {likesCount > 0 && (
          ...
          >
            ...
            <span className="text-sm font-semibold text-pink-700 dark:text-pink-300">
              {likesCount} {likesCount === 1 ? 'лайк' : likesCount < 5 ? 'лайка' : 'лайков'}
            </span>
          </motion.div>
        )}
      </motion.div>
