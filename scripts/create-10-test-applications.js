...
const testApplications = [
  {
    ...
    description:
      "Мой ребенок заболел и нужна операция. Стоимость 500,000 рублей. Семья не может справиться самостоятельно.",
    story:
      "Мой сын заболел серьезным заболеванием, которое требует срочной операции. Врачи говорят, что без операции состояние будет только ухудшаться. Мы обращались в различные фонды, но помощь пока не получена. Семья состоит из меня и мужа, мы работаем, но зарплаты хватает только на основные нужды. Операция стоит 500,000 рублей, а у нас есть только 50,000. Очень просим помочь!",
    amount: 500000,
  ...
  },
  {
    ...
    description:
      "Здравствуйте! Мы многодетная семья с 4 детьми. Муж потерял работу, а я не могу работать из-за маленького ребенка. Очень нужна помощь на продукты питания и детские вещи. Любая сумма будет огромной поддержкой для нас. Заранее благодарим за понимание и помощь!",
    story:
      "Здравствуйте! Мы многодетная семья с 4 детьми. Муж потерял работу, а я не могу работать из-за маленького ребенка. Очень нужна помощь на продукты питания и детские вещи. Любая сумма будет огромной поддержкой для нас. Заранее благодарим за понимание и помощь!",
    amount: 25000,
  ...
  },
  {
    ...
    description:
      "Нужно оплатить обучение в университете. Семья не может позволить себе платное образование.",
    story:
      "Нужно оплатить обучение в университете. Семья не может позволить себе платное образование.",
    amount: 120000,
  ...
  },
  {
    ...
    description:
      "Поломался двигатель, нужен капитальный ремонт. Машина нужна для работы.",
    story:
      "Поломался двигатель, нужен капитальный ремонт. Машина нужна для работы.",
    amount: 75000,
  ...
  },
  {
    ...
    description:
      "Здравствуйте! Я пишу за свою соседку Анну Петровну, которой уже 78 лет. Она живет одна, пенсия очень маленькая, а недавно у неё сломалась стиральная машина и холодильник. Анна Петровна всегда помогала всем в доме, а теперь сама нуждается в помощи. Она очень стесняется просить, но без этих вещей ей очень тяжело. Мы хотим собрать деньги на покупку новой стиральной машины и холодильника. Анна Петровна заслуживает достойной старости, и мы надеемся, что добрые люди помогут ей в этом.",
    story:
      "Здравствуйте! Я пишу за свою соседку Анну Петровну, которой уже 78 лет. Она живет одна, пенсия очень маленькая, а недавно у неё сломалась стиральная машина и холодильник. Анна Петровна всегда помогала всем в доме, а теперь сама нуждается в помощи. Она очень стесняется просить, но без этих вещей ей очень тяжело. Мы хотим собрать деньги на покупку новой стиральной машины и холодильника. Анна Петровна заслуживает достойной старости, и мы надеемся, что добрые люди помогут ей в этом.",
    amount: 60000,
...
async function createTestApplications() {
  try {
    ...
    if (users.length === 0) {
      console.log(
        "❌ Не найдено тестовых пользователей. Сначала создайте пользователей.",
      );
      return;
    }
