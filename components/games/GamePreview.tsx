...
const GamePreview: React.FC<GamePreviewProps> = ({
  ...
  const difficultyColors = {
    'Легко': 'bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400',
    'Средне': 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400',
