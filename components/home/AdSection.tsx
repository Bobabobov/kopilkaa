...
export default function AdSection() {
  return (
    <div className="xl:order-4 order-4">
      <div className="group relative" data-sal="slide-right" data-sal-delay="300">
        ...
        <div className="relative space-y-4 text-center">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="p-2 bg-white/40 dark:bg-[#0F2A1D]/20 rounded-lg">
              <div className="font-bold text-gray-900 dark:text-white">1000+</div>
              <div className="text-gray-600 dark:text-gray-400">посетителей</div>
            </div>
            <div className="p-2 bg-white/40 dark:bg-[#0F2A1D]/20 rounded-lg">
