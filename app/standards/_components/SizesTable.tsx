...
const tableData = [
  {
    ...
    image: (
      <>
        Десктоп: 1400×250px (contain)
        <br />
        <span className="text-xs text-[#f9bc60]">
          Мобильный: 1080×300px (contain)
        </span>
      </>
    ),
  ...
  return (
    ...
    >
      <div className="text-center mb-6 sm:mb-8 px-4">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#fffffe] px-4">
            ...
            <table className="w-full border-collapse min-w-[600px]">
              <thead>
                <tr className="border-b-2 border-[#f9bc60]/30">
                  <th className="text-left p-3 md:p-4 text-[#f9bc60] font-bold text-sm md:text-base">
                    Формат
                  </th>
                  <th className="text-left p-3 md:p-4 text-[#f9bc60] font-bold text-sm md:text-base">
                    Размер контейнера
              ...
              <tbody>
                {tableData.map((row, idx) => (
                  ...
                  >
                    <td className="p-3 md:p-4 text-[#fffffe] font-semibold text-sm md:text-base">
                      {row.format}
                    </td>
                    <td className="p-3 md:p-4 text-[#abd1c6] text-sm md:text-base">
                      {row.container}
                    </td>
                    <td className="p-3 md:p-4 text-[#abd1c6] text-sm md:text-base">
                      {row.image}
                    </td>
                    <td className="p-3 md:p-4 text-[#abd1c6] font-semibold text-sm md:text-base">
                      {row.maxImages}
                    </td>
                  </motion.tr>
                ))}
            ...
            {tableData.map((row, idx) => (
              ...
              >
                <div className="mb-3 pb-3 border-b border-[#f9bc60]/30">
                  <h3 className="text-[#f9bc60] font-bold text-sm mb-1">
                    Формат
                  </h3>
                  <p className="text-[#fffffe] font-semibold text-base">
                    {row.format}
                  </p>
                </div>
                <div className="space-y-2">
                  <div>
                    <h4 className="text-[#f9bc60] font-semibold text-xs mb-1">
                      Размер контейнера
                    </h4>
                  ...
                  <div>
                    ...
                    <p className="text-[#abd1c6] font-semibold text-sm">
                      {row.maxImages}
                    </p>
                  </div>
                </div>
