...
export const SiteIcons = {
  ...
  // Календарь
  Calendar: ({ className = "", size = "md" }: Omit<IconProps, "children">) => (
    <Icon className={className} size={size}>
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
        <path d="M19,3H18V1H16V3H8V1H6V3H5A2,2 0 0,0 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5A2,2 0 0,0 19,3M19,19H5V8H19V19M7,10H9V12H7V10M11,10H13V12H11V10M15,10H17V12H15V10M7,14H9V16H7V14M11,14H13V16H11V14M15,14H17V16H15V14Z" />
      </svg>
    </Icon>
  ),
};
