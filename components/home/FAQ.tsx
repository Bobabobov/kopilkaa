...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Деньги обрабатываются через платёжную систему — банки и сервисы берут небольшую комиссию, поэтому до копилки доходит чуть меньше 100% суммы. Баланс на сайте показывает, сколько средств собрано. Когда одобряется заявка, деньги переводятся человеку, а баланс копилки уменьшается. Всё прозрачно: общий фонд, из которого помогаем людям.",
    icon: "PiggyBank",
  },
  {
