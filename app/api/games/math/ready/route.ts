...
import { acknowledgeMathSprintReady } from '@/lib/games/mathSprint';
...
export async function POST(request: Request) {
  try {
    ...
    const ready = await acknowledgeMathSprintReady(session.uid);
    ...
    logRouteCatchError('[API POST /api/games/math/ready]', error);
