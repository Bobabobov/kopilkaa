      ...
      <div className="relative z-10 w-full px-6 pt-32 pb-8">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Настройки профиля</h1>
              <p className="text-gray-600 dark:text-gray-400">Управление вашими данными и предпочтениями</p>
            </div>
          </div>
        </div>
      </div>
