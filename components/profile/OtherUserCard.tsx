      ...
      >
        ...
        <div className="relative z-10">
            ...
            <div className="relative inline-block group/avatar">
              {(() => {
                ...
                if (frame.type === 'image') {
                  ...
                  return (
                    <div className={`w-24 h-24 rounded-lg flex items-center justify-center text-white font-bold text-2xl shadow-2xl mx-auto mb-4 group-hover/avatar:scale-105 transition-transform duration-300 ${frame.className} ${
          ...
          >
            <div className="group/info bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 rounded-2xl p-4 hover:from-emerald-100 hover:to-green-100 dark:hover:from-emerald-900/30 dark:hover:to-green-900/30 transition-all duration-300">
              <div className="flex justify-between items-center">
                <span className="text-gray-600 dark:text-gray-400 text-sm group-hover/info:text-emerald-600 dark:group-hover/info:text-emerald-400 transition-colors">Дата регистрации:</span>
          ...
          >
            ...
            {friendship && friendship.status === "PENDING" && friendship.requesterId !== currentUserId && (
              <motion.div 
                ...
                <motion.div whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }}>
                  <Link 
                    ...
                    onClick={(e) => {
                      ...
                      const event = new CustomEvent('open-friends-modal', { detail: { tab: 'search' } });
