      ...
      <Link href={`/stories/${story.id}`}>
        <div className="bg-white/90 backdrop-blur-xl rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-white/20 hover:-translate-y-1 h-full max-w-full overflow-hidden flex flex-col"
          ...
          <div className="flex flex-col flex-1 min-w-0">
            {/* Заголовок */}
            <h3 className="text-xl font-bold transition-colors line-clamp-2 break-words overflow-hidden mb-3 h-16" style={{ color: '#001e1d' }}>
              {story.title}
            </h3>
            
            {/* Описание */}
            <p className="text-sm leading-relaxed line-clamp-3 break-words overflow-hidden flex-1 mb-4 h-20" style={{ color: '#2d5a4e' }}>
              {story.summary}
            </p>
