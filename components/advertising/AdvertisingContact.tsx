    ...
    try {
      ...
      if (!email) {
        ...
        if (!emailRegex.test(email)) {
          newErrors.contact =
            "Некорректный email адрес. Пример: your@email.com";
        }
      }
        ...
        >
          <div className="space-y-10">
            ...
            >
              ...
              >
                <option value="" className="bg-[#001e1d] text-[#abd1c6]">
                  Выберите формат
                </option>
                <option value="banner" className="bg-[#001e1d] text-[#fffffe]">
                  Большой баннер наверху — Договорная цена
                </option>
                <option value="side" className="bg-[#001e1d] text-[#fffffe]">
                  Блок сбоку — Договорная цена
                </option>
                <option value="story" className="bg-[#001e1d] text-[#fffffe]">
                  Рекламная история — Договорная цена
                </option>
                <option value="tg" className="bg-[#001e1d] text-[#fffffe]">
                  Telegram пост — Договорная цена
                </option>
                <option value="other" className="bg-[#001e1d] text-[#fffffe]">
            ...
            >
              ...
              {!errors.message && formData.message.length > 400 && (
                <motion.p
                  ...
                  className="text-red-400 text-sm mt-3 flex items-center gap-2"
                >
                  <span>⚠</span> Превышено максимальное количество символов
                  (400)
                </motion.p>
              )}
            </motion.div>
