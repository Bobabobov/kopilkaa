...
export const metadata: Metadata = {
  ...
  title: {
    default: "Копилка Online — платформа живых историй и творческих грантов",
    template: "%s | Копилка",
  },
  description:
  ...
  openGraph: {
    ...
    url: "/",
    siteName: "Копилка",
    title: "Копилка Online — платформа живых историй и творческих грантов",
    description:
      "Медиа-платформа уникальных жизненных историй с выплатой поощрительных гонораров авторам",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Копилка Online — платформа живых историй",
      },
    ],
  },
  twitter: {
