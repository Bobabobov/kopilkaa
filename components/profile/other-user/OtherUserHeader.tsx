  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          className="absolute -top-32 -right-32 w-64 h-64 bg-gradient-to-br from-[#f9bc60]/15 to-[#abd1c6]/10 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.1, 1],
            opacity: [0.3, 0.5, 0.3],
          }}
        ...
        />
        <motion.div
          className="absolute -bottom-24 -left-24 w-48 h-48 bg-gradient-to-br from-[#abd1c6]/15 to-[#f9bc60]/10 rounded-full blur-2xl"
          animate={{
            scale: [1.1, 1, 1.1],
            opacity: [0.4, 0.2, 0.4],
          }}
        ...
        />
        <motion.div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-gradient-to-br from-[#abd1c6]/10 to-[#f9bc60]/10 rounded-full blur-3xl"
          animate={{
            rotate: [0, 360],
            scale: [1, 1.2, 1],
          }}
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 lg:gap-8">
            ...
            <div className="flex-1">
              ...
              >
                ...
                <h1
                  className={`text-3xl sm:text-4xl lg:text-5xl font-bold text-[#fffffe] drop-shadow-lg`}
                >
              ...
              <motion.p
                className="text-lg sm:text-xl text-[#abd1c6] opacity-90 mb-4"
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6">
                <motion.div
                  className="flex items-center gap-2 text-sm text-[#abd1c6] opacity-90"
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.4 }}
                >
                  <div className="w-2 h-2 bg-[#f9bc60] rounded-full animate-pulse"></div>
                  <span>
                    Участник с{" "}
            ...
            >
              ...
              >
                <Link
                  href="/profile"
                  className="px-6 py-3 bg-[#f9bc60]/20 hover:bg-[#f9bc60]/30 text-[#fffffe] rounded-xl transition-all duration-300 font-medium text-sm shadow-lg text-center block"
                >
                  Мой профиль
                </Link>
              </motion.div>
